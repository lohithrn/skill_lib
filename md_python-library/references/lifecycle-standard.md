# The artifact lifecycle standard

The arc-2 rulebook: the end-to-end lifecycle of a library whose resource manifest is baked into the
wheel at deploy time. Cited from `SKILL.md` as **arc 2 — lifecycle**.
