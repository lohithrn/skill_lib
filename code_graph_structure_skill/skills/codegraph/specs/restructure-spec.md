...
user approves this file. `/codegraph apply` refuses to run without it.
...
`/codegraph apply` reads this block. Unchecked approval ⇒ it refuses and prints what is missing.
