...
```sh
bash skills/md_codegraph/scripts/graph.sh --root . --json > graph.json   # machine form
bash skills/md_codegraph/scripts/graph.sh --root . --text                # human form
bash skills/md_codegraph/scripts/graph.sh --root . --exclude 'vendor/**' --json
```
