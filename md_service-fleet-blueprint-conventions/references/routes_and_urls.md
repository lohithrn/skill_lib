...
and the environment blocks of ten lambdas become the place URLs actually live. The build arc ships the resolver this convention depends on, as a template.
